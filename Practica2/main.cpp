...
int main()
{
    ...
    int idHospital, maxCamas, codigoPostal;

    cout << "Hello world!" << endl;
    Hospital hos(nombreHospital, idHospital, maxCamas, codigoPostal, tipoHospital);

    cadena nombreh;
    cout << "Dime el nombre de un hospital" << endl;
    cin >> nombreh;
    hos.getNombreHospital(nombreh);
    return 0;
}
